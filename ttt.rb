...
class Game < Field
    ...
    def check? 
        ...
        loop do 
            #!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            row = @fields[(i..z)].all? {|el| el.value == "O".green
                } || @fields[(i..z)].all? {|el| el.value == "X".red
                }
            if(row == true)
        ...
        loop do
            #**********************************
            column = @fields[(i..z).step(3)].all? {|el| el.value == "O".green} || @fields[(i..z).step(3)].all? {|el| el.value == "X".red}
            if(column == true)
                if(@fields[i].value == "O".green)
                    @who_won = "You won!"
                elsif(@fields[i].value == "X".red
        ...
        loop do
            #**********************************            
            diagonal = @fields[(i..z).step(c)].all? {|el| el.value == "O".green} || @fields[(i..z).step(c)].all? {|el| el.value == "X".red}
            if(diagonal == true)
